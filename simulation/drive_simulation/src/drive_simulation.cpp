...
{
  ros::init(argc, argv, "drive_simulation");

  ros::NodeHandle nh("simul_driver");
  ...
  while(nh.ok())
  {
    ...
    // setup tf frame ----- to be provided to tf node
    ...
    //setup odom frame ----- to be published by current node
